...
// BQTriggerRequest represents the request for the BigQuery trigger.
// See: https://docs.cloud.google.com/bigquery/docs/remote-functions#input_format
type BQTriggerRequest struct {
	// Unique ID for this request from BigQuery
	RequestID string `json:"requestId"`
	// Email of the BigQuery user who triggered the query
	Caller string `json:"caller"`
	// Email of the session user in BigQuery.
